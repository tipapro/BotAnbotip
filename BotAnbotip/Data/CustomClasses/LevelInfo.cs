...
namespace BotAnbotip.Data.CustomClasses
{
    class LevelInfo
    {
        public static Dictionary<LevelRoleIds, long> Points = new Dictionary<LevelRoleIds, long>
        {
            ...
            { LevelRoleIds.Bronze3, 3789 },
            { LevelRoleIds.Silver1, 5489 },
            { LevelRoleIds.Silver2, 8503 },
            ...
            { LevelRoleIds.Ruby1, 668246 },
            { LevelRoleIds.Ruby2, 937654 },
            { LevelRoleIds.Ruby3, 1198793 },
            { LevelRoleIds.Diamond1, 1895275 },
            { LevelRoleIds.Diamond2, 3422674 },
            { LevelRoleIds.Diamond3, 5094876 },
            { LevelRoleIds.Magma1, 8203467 },
            { LevelRoleIds.Magma2, 11537986 },
            { LevelRoleIds.Magma3, 16909458 },
            { LevelRoleIds.Dark_matter1, 23741347 },
